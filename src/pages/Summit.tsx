            ...
            <div className="container mx-auto px-6 md:px-12 lg:px-20">
              <div className="grid lg:grid-cols-2 gap-12 md:gap-16 lg:gap-24 items-center">
                ...
                <div className={`space-y-6 md:space-y-8 max-w-xl ${sectionIndex === 1 ? 'md:text-right md:ml-auto' : ''}`}>
                  <h2 className="text-2xl md:text-2xl lg:text-4xl font-medium tracking-tight">
                    {section.subject}
                  </h2>
                  ...
                  <div className="space-y-6 md:space-y-8">
                    {section.paragraphs.map((paragraph, index) => (
                      <p 
                        key={index}
                        className="text-sm md:text-sm text-muted-foreground leading-[1.8] whitespace-pre-line"
                      >
                        {paragraph}
                      </p>
                    ))}
