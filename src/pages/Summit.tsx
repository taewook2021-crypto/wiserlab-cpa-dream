            ...
            <div className="bg-background p-8 sm:p-10 md:p-24 flex flex-col justify-center">
              <div className="space-y-8 sm:space-y-10 md:space-y-16">
                {FEATURES.map((feature, index) => (
                  ...
                  >
                    <h3 className="text-base sm:text-base md:text-xl font-medium mb-3 sm:mb-4 md:mb-6">
                      {feature.title}
                    </h3>
                    <p className="text-sm sm:text-sm md:text-base text-muted-foreground leading-relaxed whitespace-pre-line">
                      {feature.description}
                    </p>
                  </div>
                ))}
